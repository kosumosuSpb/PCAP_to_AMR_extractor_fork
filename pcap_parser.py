...
sample_noise_amrnb = b'<T\xf4\xb1\xd81\xbb\x81\x80\x8d\xe5\x0f\xe2\x10`V\x80\x00#\xc5\xd3E\x00\x10\x00\x07\x85"[\xe0`\x10'
# samples for silence
sample_silence_amrwb = b'\x04\x10!\x009\x1d7\xd4\x91t|\xc2x\xe8\xe0\x88\xe2\xe0'
sample_silence_amrnb = b'<Y$\xb6\xf8\x12K\x81\x80\x89\xe7\xef\xc0R`D\xc0\x00N\x85\xfdu\x80\x00\x00\x00y(X H\xa0'
# /SILENCE FRAME REPLACER CODE BYTE SAMPLES
